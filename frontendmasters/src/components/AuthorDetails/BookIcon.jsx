		...
		<div>
			<div>
				<svg
					...
					width="120px"
					height="120px"
					viewBox="0 0 795.035 795.035"
					style={{ enableBackground: "new 0 0 795.035 795.035" }}
				>
					<defs>
					...
					<path
						fill="url(#linear)"
						d="M0,647.589c0,49.892,40.588,90.479,90.479,90.479h20.108h552.079h40.211h41.895v-40.212h-41.895V597.322h41.895v-17.594
